...
AInjector1 = 0.25 * pi * (3e-3).^2; %Injector hole 1 cross section in m^3
% pipe2A = 0.25*pi*(pipeInternalDiameter).^2;
pipe2A = AInjector1;

pipeInternalDiameter = 6.8326e-3;
